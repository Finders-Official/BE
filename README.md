...
3. 현상 예약 및 주문 상태 관리
4. 결제 처리 및 웹훅 검증 (PortOne)
5. AI 사진 복원 (Replicate)
6. 커뮤니티 게시글/댓글/좋아요
7. 파일 업로드 및 이미지 스토리지 연동 (GCS)
...
<table>
  <tr>
    ...
    <td align="center" width="150">
      ...
      <a href="https://www.notion.so/206ffc6159c0809eba5cc7291f5f546e?source=copy_link"><img src="https://img.shields.io/badge/-Portfolio-E94E16?style=flat-square&logo=googlechrome&logoColor=white" alt="Portfolio"/></a>
    </td>
    <td align="center" width="150">
...
|---|---|---|
| Dev | `develop` | `dev-api.finders.it.kr` |
| Prod | `main` | `api.finders.it.kr` |
...
- Local Swagger: `http://localhost:8080/api/swagger-ui.html`
- Local OpenAPI: `http://localhost:8080/api/v3/api-docs`
- Dev Swagger: `https://dev-api.finders.it.kr/api/swagger-ui.html`

### docs/ 패키지 구조 (링크 + 주석 설명)

<pre>
docs/
├─ <a href="docs/README.md">README.md</a> // docs 전체 인덱스
├─ architecture/
│  ├─ <a href="docs/architecture/ARCHITECTURE.md">ARCHITECTURE.md</a> // 백엔드 아키텍처/레이어/패키지 구조
│  ├─ <a href="docs/architecture/ERD.md">ERD.md</a> // 도메인별 ERD, DDL, 인덱스, enum 정의
│  └─ <a href="docs/architecture/INFRASTRUCTURE.md">INFRASTRUCTURE.md</a> // GCP 인프라 구성, 환경/배포 전략
├─ development/
│  ├─ <a href="docs/development/API.md">API.md</a> // API 엔드포인트 명세
│  ├─ <a href="docs/development/CODE_STYLE.md">CODE_STYLE.md</a> // Java/Spring 코드 스타일 가이드
│  └─ <a href="docs/development/CONVENTIONS.md">CONVENTIONS.md</a> // 브랜치/커밋/네이밍 컨벤션
├─ guides/
│  ├─ <a href="docs/guides/AUTHENTICATION_PRINCIPAL.md">AUTHENTICATION_PRINCIPAL.md</a> // 인증 principal/보안 컨텍스트 가이드
│  ├─ <a href="docs/guides/ENV_VARIABLES.md">ENV_VARIABLES.md</a> // 환경변수/시크릿 관리 가이드
│  ├─ <a href="docs/guides/GCS_SETUP.md">GCS_SETUP.md</a> // GCS 설정/권한/사용법
│  ├─ <a href="docs/guides/LOCAL_DEVELOPMENT.md">LOCAL_DEVELOPMENT.md</a> // 로컬 개발 환경 세팅
│  └─ <a href="docs/guides/REMOTE_DB_ACCESS.md">REMOTE_DB_ACCESS.md</a> // 원격 DB 접속 방법
└─ infra/
   ├─ <a href="docs/infra/README.md">README.md</a> // 인프라 문서 인덱스
   ├─ <a href="docs/infra/GCP_LOGGING_GUIDE.md">GCP_LOGGING_GUIDE.md</a> // GCP 로그 조회/운영 가이드
   ├─ <a href="docs/infra/IAC_TERRAFORM_INTRO.md">IAC_TERRAFORM_INTRO.md</a> // Terraform IaC 입문
   ├─ <a href="docs/infra/SECRET_MANAGEMENT.md">SECRET_MANAGEMENT.md</a> // Secret Manager 운영 가이드
   └─ <a href="docs/infra/TERRAFORM_OPERATIONS.md">TERRAFORM_OPERATIONS.md</a> // Terraform 실무 운영 절차
</pre>
